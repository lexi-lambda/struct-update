...
@let[([struct-id? @elem{@racketvarfont{struct-id}@racketidfont{?}}])]{@list{
...
binding}, generates functional setter and updater functions for each field of the struct. Functions
are only generated for the non-inherited fields for the provided struct; a supertype’s fields are
ignored.
